...
CODEX_MODEL_CHOICES_VALUE="${CODEX_MODEL_CHOICES:-$(env_get CODEX_MODEL_CHOICES)}"
...
ATTACHMENT_DOWNLOAD_TIMEOUT_SECONDS_VALUE="${ATTACHMENT_DOWNLOAD_TIMEOUT_SECONDS:-$(env_get ATTACHMENT_DOWNLOAD_TIMEOUT_SECONDS)}"
ATTACHMENT_MAX_FILE_BYTES_VALUE="${ATTACHMENT_MAX_FILE_BYTES:-$(env_get ATTACHMENT_MAX_FILE_BYTES)}"
ATTACHMENT_MAX_TOTAL_BYTES_VALUE="${ATTACHMENT_MAX_TOTAL_BYTES:-$(env_get ATTACHMENT_MAX_TOTAL_BYTES)}"
HIDE_WORKSPACE_PATHS_VALUE="${HIDE_WORKSPACE_PATHS:-$(env_get HIDE_WORKSPACE_PATHS)}"
...
CODEX_MODEL_CHOICES_VALUE="$(tty_read "Codex model choices for Discord settings, comma-separated" "${CODEX_MODEL_CHOICES_VALUE}")"
...
ATTACHMENT_DOWNLOAD_TIMEOUT_SECONDS_VALUE="$(tty_read "Attachment download timeout in seconds (0 disables)" "${ATTACHMENT_DOWNLOAD_TIMEOUT_SECONDS_VALUE:-60}")"
ATTACHMENT_MAX_FILE_BYTES_VALUE="$(tty_read "Attachment max file size in bytes" "${ATTACHMENT_MAX_FILE_BYTES_VALUE:-26214400}")"
ATTACHMENT_MAX_TOTAL_BYTES_VALUE="$(tty_read "Attachment max total size in bytes" "${ATTACHMENT_MAX_TOTAL_BYTES_VALUE:-104857600}")"
HIDE_WORKSPACE_PATHS_VALUE="$(tty_read "Hide workspace paths in Discord (0 or 1)" "${HIDE_WORKSPACE_PATHS_VALUE:-0}")"
...
CODEX_MODEL_CHOICES="$(escape_env_value "${CODEX_MODEL_CHOICES_VALUE}")"
...
ATTACHMENT_DOWNLOAD_TIMEOUT_SECONDS="$(escape_env_value "${ATTACHMENT_DOWNLOAD_TIMEOUT_SECONDS_VALUE}")"
ATTACHMENT_MAX_FILE_BYTES="$(escape_env_value "${ATTACHMENT_MAX_FILE_BYTES_VALUE}")"
ATTACHMENT_MAX_TOTAL_BYTES="$(escape_env_value "${ATTACHMENT_MAX_TOTAL_BYTES_VALUE}")"
HIDE_WORKSPACE_PATHS="$(escape_env_value "${HIDE_WORKSPACE_PATHS_VALUE}")"
