...
const messages = {
  en: {
    ...
    recoveryQueued: "Service restart detected; queued the previous job for recovery.",
    recoveryStarted: "Resuming the previous job in the existing Codex session.",
  ...
  ko: {
    ...
    recoveryQueued: "서비스 재시작을 감지해 이전 작업을 복구 대기열에 추가했습니다.",
    recoveryStarted: "기존 Codex 세션에서 이전 작업을 이어서 실행합니다.",
